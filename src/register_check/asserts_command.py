"""Command assertions — the `register-check assert <name>` closed set.
...
from register_check.repo import Repo, load_jsonc
...
#: does.
_SELF = "register-check"

#: The subcommands that audit no control. Running the checker is not the same as
#: auditing with it: `register-check schema` validates the register and reads not
