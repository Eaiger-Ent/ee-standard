...
`kind: command`, via `register-check assert <name>` strings. That was theme
...
from register_check.asserts_command import COMMAND_ASSERTS
from register_check.asserts_file import FILE_ASSERTS, AssertFn
...
#: `kind: file` blocks against, and the set `register-check assert <name>`
